...
<html lang="en">
    ...
    <body>
       <header>
        ...
        <section>
            <h1 class="white-text"><big>Fitness Activities You Can Try!</h1></big>
            <p class="white-text"><i><small>If it does not challenge you, it does not change you.</p></i></small>
        </section>
        
        <section>
            <h2 class="white-text">Recommended Fitness Activities</h2>
