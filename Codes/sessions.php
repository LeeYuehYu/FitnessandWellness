...
<html lang="en">
    ...
    <body>
        ...
        <nav>
            ...
            <div class="nav-right"> 
                <a href="progress%20tracking.php" target=_self>Home</a>
        ...
        <section>   
            <h1 class="white-text"><big>Wellness Sessions You Can Try!</h1></big>
            <p class="white-text"><i><small>Health is a state of mind, Wellness is a state of being.
            </p></i></small>
        </section>
        
        <section>
            <h2 class="white-text">Wellness Sessions</h2>
        ...
        <script>
            document.getElementById('profile-icon').addEventListener('click', function() {
                window.location.href = 'profile%20management.php';
            });
        </script>
